...
const ProductPage = () => {
  return (
    <Grid container height = "100vh">
      <Grid item sx={{  display: "flex", justifyContent:"center",alignItems:"center",flexDirection: "column" }} md={6} xs={12} sm={12} height = "80vh" gap={4}>
        <div  sx={{  display: "flex", justifyContent:"center",alignItems:"center",flexDirection: "column" }} >
          <Box boxShadow="8" height= "auto" width = "55vh"pl={2} borderRadius="20px" border="2px solid black"  justifyContent="center">
