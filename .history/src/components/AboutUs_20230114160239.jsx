              ...
              <CardContent className={classes.cardContent}>
                ...
                <List>
                  <ListItem className={classes.listItem}>
                    <ListItemAvatar>
                      <Avatar src="/static/images/avatar/1.jpg" className={classes.avatar}>JH</Avatar>
                    </ListItemAvatar>
                    <ListItemText
                      primary="John Doe"
                  ...
                  <ListItem className={classes.listItem}>
                    <ListItemAvatar>
                      <Avatar src="/static/images/avatar/1.jpg" className={classes.avatar}>AM</Avatar>
                    </ListItemAvatar>
                    <ListItemText
                  ...
                  <ListItem className={classes.listItem}>
                    <ListItemAvatar>
                      <Avatar src="https://www.google.com/imgres?imgurl=https%3A%2F%2Freactjs.org%2Flogo-og.png&imgrefurl=https%3A%2F%2Freactjs.org%2F&tbnid=viJ6CsTiT3pOsM&vet=12ahUKEwiwuNfG9Mb8AhXJmycCHRC8BzEQMygDegUIARDNAQ..i&docid=dzSQNmg7y31FRM&w=1200&h=630&q=react%20js%20logo&ved=2ahUKEwiwuNfG9Mb8AhXJmycCHRC8BzEQMygDegUIARDNAQ" className={classes.avatar}>RB</Avatar>
                    </ListItemAvatar>
                    <ListItemText
