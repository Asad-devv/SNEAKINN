      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="bg-white/90 h-auto w-[7vh] sm:w-[8vh] blur-effect-theme button-theme px-2 py-1 shadow  text-sm text-black"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
            ...
            <button  type="button"
              className="bg-white/90 blur-effect-theme  sm:h-[auto] w-[7vh] sm:w-[2vh] button-theme p-0.5 shadow" ><Link to={`/Products/${id}`}>See More</Link></button>
