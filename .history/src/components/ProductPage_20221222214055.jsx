    ...
    <Grid container height = "100vh">
      <Grid item sx={{  display: "flex", justifyContent:"center",alignItems:"center",flexDirection: "column" }} md={6} xs={12} sm={12} height = "80vh">
        <div  sx={{  display: "flex", justifyContent:"center",alignItems:"center",flexDirection: "column" }} >
          <Box justifyContent="center">
            <Image src="src/components/hero.png" sx={{ borderRadius:"10px", } height= "40vh" width = "40vh " fit="contain" />
          </Box>
      ...
      <Grid height="80vh" sx={{  display: "flex", justifyContent:"center",alignItems:"a ",flexDirection: "column" }} item md={6} xs={12} sm={12}>
        ...
        <Box display="flex" border="2px solid black" borderRadius="5px" height="30px" width="200px" my={3}>
          <Typography sx={{borderRadius:"2px" ,width:"40px",height:"20px",textAlign:"center",marginLeft:"10px" ,cursor:"pointer"}} variant="subtitle">-</Typography>
