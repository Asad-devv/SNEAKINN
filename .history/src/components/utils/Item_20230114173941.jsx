      ...
      >
        ...
        >
          ...
          <div className="flex items-center pb-3 gap-3">
            ...
            <button  type="button"
              className="bg-white/90 blur-effect-theme h-auto w-auto  button-theme p-0.5 hover:scale-110 shadow" ><Link to={`/Products/${id}`} style={{fontFamily:"Unbounded"}} >See More</Link></button>
