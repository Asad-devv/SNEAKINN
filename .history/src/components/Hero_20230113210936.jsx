    ...
    <>
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-20 sm:mt-10">
            <h1
            ...
            <button
              type="button"
              style={{ fontFamily: "Poppins" ,fontSize  : "17px", fontWeight: "500"}}
              className="button-theme bg-slate-300  shadow rounded-sm my-5"
          ...
          <div className="flex items-center">
            <img
              src="src/components/hero.png"
              alt="hero-img/img"
              className="w-[65vh] md:w-[24vh] h-[65vh] lg:h-[40vh] lg:w-auto md:h-[26vh] sm:w-[27vh] sm:h-[25vh] xsm:h-[19vh] rotate-12 transitions-theme hover:rotate-0 cursor-pointer object-fill shadow-lg shadow-violet-500 "
            />
          </div>
        </div>
      </div>
