...
<ThemeProvider theme={styles}>
    ...
    <Grid container display="flex" spacing={2} my={2}>
        <Grid sx={{backgroundColor:"pink"}}display = "flex" flexDirection = "column"  justifyContent="center" height="" item md={6} xs={12} sm={12}>
          
        <Typography fontWeight="9" variant="h1">BEST SNEAKERS </Typography>
