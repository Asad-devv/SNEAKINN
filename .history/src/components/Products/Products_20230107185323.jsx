...
const MyCarousel = () => {
  return (
    <Carousel className="h-64" style={{height : "1000vh"}} autoplay={true} wrapAround={true} autoplayInterval={2000} style={{height : "50vh"}}>
      {images.map((image,i)=>{
        return(
        <img src={image} alt="image" className='h-full w-full object-contain	 ' key={i}/>
        )
      })}
    </Carousel>
  );
