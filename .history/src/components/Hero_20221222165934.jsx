      ...
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            ...
            <div className='grid items-center absolute top-[33vh] lg:top-[27vh] right-9 gap-4'>
          ...
          <div className='flex items-center'>
            <img
              src="src/components/hero.png"
              alt='hero-img/img'
              className='w-[70vh] md:w-[28vh] h-[456vh] lg:h-[39vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] rotate-12 transitions-theme hover:rotate-0 cursor-pointer object-fill'
            />
          </div>
        </div>
      </div>
