...
const useStyles = makeStyles((theme) => ({
  ...
  hero: {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://sneakernews.com/wp-content/uploads/2022/12/jordan-release-dates-2023-spring.jpg')`,
    height: "500px",
