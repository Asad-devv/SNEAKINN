...
const ProductPage = () => {
  ...
  const findPrice =async (item)=>{
    const retailPrice = await item.find((trait) => trait.name === "retail-price");
  ...
  return (
    ...
    <Grid container height="100vh">
      ...
      >
        ...
        <Typography variant="subtitle1">{!isDemo?((product?.traits?.findPrice(traits) )?.value): (product?.price)}$</Typography>
        <Box display="flex" >
          <Box
            display="flex"
