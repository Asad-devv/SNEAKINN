        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          ...
          <div className="flex items-center">
            <img
              src="src/components/hero.png"
              alt="hero-img/img"
              className="w-[65vh] md:w-[24vh] h-[65vh] lg:h-[40vh] lg:w-auto md:h-[26vh] sm sm:h-[25vh] xsm:h-[19vh] rotate-12 transitions-theme hover:rotate-0 cursor-pointer object-fill  "
            />
          </div>
        </div>
      </div>
