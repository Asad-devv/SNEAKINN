  ...
  return (
    <Grid container>
      ...
      >
        ...
        <Box width="50vh" sx={{width:{xs:"40vh"}}}>
          ...
          <Box display = "flex" justifyContent= "space-between">
            ...
            <Typography variant="subtitle" fontSize="10pax">{product?.model.substring(0,18)}</Typography>
          </Box>


          <Box display = "flex" justifyContent= "space-between">
            <Typography>Highest Bid : </Typography>
            <Typography>{product?.market?.bids.highest_bid}</Typography>
          </Box></>)
}
          <Box display="flex">
            <Box >
