      ...
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            ...
            <button type='button' className='button-theme bg-slate-200  shadow-slate-900 rounded-md my-5'>{btntext}</button>
            <div className='grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[9%] xl:left-0 w-auto h-auto'>
              {videos?.map((val, i) => (
                <Clips
                  key={i}
                  imgsrc={val.imgsrc}
            ...
            <div className='grid items-center absolute top-[33vh] lg:top-[27vh] right-[10vh] md:right-[1vh] gap-5'>
          ...
          <div className='flex items-center'>
            <img
              src="src/components/hero.png"
              alt='hero-img/img'
              className='w-[65vh] md:w-[28vh] md:h- h-[60vh] lg:h-[39vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] rotate-12 transitions-theme hover:rotate-0 cursor-pointer object-fill'
            />
          </div>
        </div>
      </div>
