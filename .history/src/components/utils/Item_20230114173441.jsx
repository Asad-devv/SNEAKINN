      ...
      >
        ...
        >
          ...
          <div className="flex items-center pb-3 gap-3">
            <button
              type="button"
              className="bg-white/90 blur-effect-theme hover:scale-125  h-auto button-theme p-0.5 drop-shadow"
              onClick={() => onAddToCart()}
            >
            ...
            <button  type="button"
              className="bg-white/90 blur-effect-theme h-auto w-auto  button-theme p-0.5 hover:scale-125 shadow" ><Link to={`/Products/${id}`}>See More</Link></button>
