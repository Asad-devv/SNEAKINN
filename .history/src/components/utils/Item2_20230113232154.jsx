      ...
      >
        <div className={`grid items-center justify-items-center`}>
          ...
          <div className="flex items-center gap-3 ">
            <button
              type="button"
              className="bg-white/90 blur-effect-theme button-theme  shadow-gray-400 p-0.5 shadow"
              onClick={() => onAddToCart()}
            >
            ...
            <button
              type="button"
              className=" shadow-gray-400 bg-white/90 blur-effect-theme button-theme px-2 py-1 shadow text-sm text-black"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
            ...
            <button
              type="button"
              className="bg-white/90 text-sm px-2 py-1  shadow-gray-400 blur-effect-theme button-theme  shadow"
            >
