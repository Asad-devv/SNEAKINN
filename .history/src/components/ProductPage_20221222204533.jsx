...
const ProductPage = () => {
  return (
    <Grid container height = "100vh">
      ...
      <Grid height="80vh" sx={{  display: "flex", justifyContent:"a",alignItems:"center",flexDirection: "column" }} item md={6} xs={12} sm={12}>
        <Typography variant="h6" gutterBottom>
          Sneakin
        </Typography>
        <Typography variant="h5">Air jordan 1 Traviss Scott</Typography>
      </Grid>
    </Grid>
  );
};
