...
const useStyles = makeStyles((theme) => ({
  ...
  hero: {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsJjZgBbtZB6CY6PxiQfgm1ZL0mWHjYayy1g&usqp=CAU')`,
    height: "500px",
  ...
  return (
    <div className="App">
      ...
      <Box className={classes.hero}>
        <Box>WELCOME TO SNEAKERS BLOG</Box>
      </Box>
      <Box mt={7}>
      <Stories  story={story} />
      </Box>
