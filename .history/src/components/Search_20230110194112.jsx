...
const SearchBar = ({
  ...
  return (
    <Box display="flex" flexDirection="column">
      <Box sx={{ width: {sm:"12vh",md:"20vh",lg:"40vh"}, borderRadius: "30px" }}>
        <TextField
            ...
            endAdornment: (
              <IconButton onClick={handleIconClick}>
                <Link to={`/products/search/${searchValue}`}>
                  ...
                  <SearchIcon p={5} sx={{border :"1px solid black",backgroundColor:"#ccc7c7",borderRadius:"50%",fontSize:{md:"10px",sm:"12px"}}} />
                </Link>
              </IconButton>
            ),
          }}
