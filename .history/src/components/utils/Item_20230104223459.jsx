    ...
    <>
      <div
        className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center ${
          ifExists ? "justify-items-start h-60  " : "justify-items-center"
      ...
      >
        ...
        >
          <h1 className="text-slate-900 text-xl lg:text-lg md:text-base font-medium filter drop-shadow" style={{ fontFamily: "unbounded" }}>
            {name}
          </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="bg-white/90 h-auto w-[7vh] sm:h-[7vh] sm:w-[6vh] blur-effect-theme button-theme px-2  shadow  text-sm text-black"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
            ...
            <button  type="button"
              className="bg-white/90 blur-effect-theme sm:h-[7vh] sm:w-[6vh] w-[7vh] sm:w-[8vh] button-theme p-0.5 shadow" ><Link to={`/Products/${id}`}>See More</Link></button>
