...
import { Button, Typography, Divider, TextField,IconButton } from "@mui/material";
...
const SearchBar = ({
  ...
  }} label="Search" variant="outlined" onChange={handleSearch} />
      </Box>
                ...
                i < 3 && (
                  ...
                  >
                    <Typography
                      ...
                      variant="subtitle"
                    >
                      <Link to={`/Products/${val.id}`}> {val.title}</Link>
                    </Typography>
                    <Divider color="grey" />
                  </div>
                )
