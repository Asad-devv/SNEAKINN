...
In the above program you provided, the variables p1 and p2 are pointers, not actual variables. A pointer is a variable that stores the memory address of another variable.
