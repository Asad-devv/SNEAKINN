...
const Item = ({
  ...
  return (
    <>
      ...
      <div
        className={`relative bg-gradient-to-b ${color} ${shadow} grid items-center rounded-md py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105`}
        style= {{height :"300px"}}
      >
        <div
