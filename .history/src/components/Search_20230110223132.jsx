...
import { styled, alpha,makeStyles,useMediaQuery } from "@mui/material/styles";
...
const widthSm = useMediaQuery(theme.breakpoints.only('sm'));
const widthMd = useMediaQuery(theme.breakpoints.only('md'));
const widthLg = useMediaQuery(theme.breakpoints.only('lg'));
...
const SearchBar = ({
  ...
  return (
    <Box display="flex" flexDirection="column">
      <Box sx={{ width: {sm:"20vh",md:"45vh",lg:"40vh"}, borderRadius: "30px" }}>
        <TextField
