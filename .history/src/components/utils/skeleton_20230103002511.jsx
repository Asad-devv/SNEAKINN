...
export default function DummySkeleton() {
  return (
    <Stack spacing={1} width="30vh" m={3} mb={5}>
      {/* For variant="text", adjust the height via font-size */}
      <Skeleton variant="text" textAlign="center" sx={{ fontSize: '1rem' }} />
      {/* For other variants, adjust the size with `width` and `height` */}
      <Stack display="flex" width="30vh" flexDirection ="row" justifyContent="center" alignItems="center" >
