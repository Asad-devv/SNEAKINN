  ...
  return (
    <Grid container height = "100vh">
      ...
      <Grid height="80vh" sx={{  display: "flex", justifyContent:"center",alignItems:"a ",flexDirection: "column" }} item md={6} xs={12} sm={12}>
        ...
        <Box display="flex" border="2px solid black" borderRadius="10px" height="25px" width="200px" py={3}>
          <Typography sx={{border:"2px solid black",borderRadius:"2px" ,width:"40px",height:"20px",textAlign:"center",marginLeft:"10px",paddingBottom:"20px" ,cursor:"pointer"}} variant="subtitle">-</Typography>
          <Typography sx={{border:"2px solid black",borderRadius:"2px" ,width:"40px",height:"20px",textAlign:"center",marginLeft:"10px",paddingBottom:"20px"}} variant="subtitle" >1</Typography>
          <Typography sx={{border:"2px solid black",borderRadius:"2px" ,width:"40px",height:"20px",textAlign:"center",marginLeft:"10px" ,cursor:"pointer",paddingBottom:"20px"}} variant="subtitle" >+</Typography>
        </Box>
      </Grid>
    </Grid>
  );
