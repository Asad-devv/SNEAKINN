...
//   };
  ...
  return (
    <>
      <div
        className={`relative bg-gradient-to-b ${color} from-blue-600 to-blue-500  shadow-lg shadow-violet-500 ${shadow} grid h-[40vh] sm:h- items-center justify-items-center rounded-md py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105 my-3 mb-4`}
        // style={{ height: "45vh" }}
      >
        <div
