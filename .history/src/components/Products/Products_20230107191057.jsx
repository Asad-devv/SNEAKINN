...
const MyCarousel = () => {
  ...
  const renderControls = ({ previousSlide, nextSlide }) => (
    <div className="controls">
      <button onClick={previousSlide} className="btn btn-primary">
        Previous
      </button>
  ...
  return (
    <Carousel renderControls={renderControls} className="h-64" autoplay={true} wrapAround={true} autoplayInterval={2000} style={{height : "90vh"}}>
      {images.map((image,i)=>{
        return(
