...
const MyCarousel = () => {
  return (
    <Carousel className="h-64" autoplay={true} wrapAround={true} autoplayInterval={2000} style={{height : "100vh"}}>
      {images.map((image,i)=>{
        return(
        <img src={image} alt="image" className='h-[100vh] w-full object-covear ' key={i}/>
        )
      })}
    </Carousel>
  );
