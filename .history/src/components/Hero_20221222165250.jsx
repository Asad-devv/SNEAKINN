      ...
      <div className='relative h-auto w-auto flex flex-col'>
        ...
        <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
          <div className='grid items-center justify-items-center mt-28 md:mt-24'>
            ...
            <div className='grid items-center gap-5 md:gap-3   top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto'>
              {videos?.map((val, i) => (
                <Clips
                  key={i}
                  imgsrc={val.imgsrc}
          ...
          <div className='flex items-center'>
            <img
              src="src/components/hero.png"
              alt='hero-img/img'
              className='w-[50vh] h-[45vh] lg:h-[39vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme hover:rotate-0 cursor-pointer object-fill'
            />
          </div>
        </div>
      </div>
