        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            <Tooltip title="Open settings">
              <ShoppingCartIcon onClick={onCartToggle} sx={{ fontSize:"25px",p: 0 }}>
                <Avatar onClick={onCartToggle} alt="Remy Sharp" src="/static/images/avatar/2.jpg" />
              </ShoppingCartIcon>
            </Tooltip>
