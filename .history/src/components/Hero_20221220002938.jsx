...
<ThemeProvider theme={styles}>
    ...
    <Grid container display="flex" spacing={2} my={1}>
        ...
        <Typography overflow="hidden" py={2} width="" fontSize="12px" variant="h6" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Et distinctio suscipit numquam quas possimus magni explicabo?</Typography>  
        </Grid>
