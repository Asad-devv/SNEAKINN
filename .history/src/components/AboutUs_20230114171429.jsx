        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={12}>
            <Paper className={classes.paper} elevation={5}>
              ...
              <div className="flex sm:flex-col justify-around	my-3">
                <Chip className={classes.chip} label="React" />
                <Chip className={classes.chip} label="Tailwind" />
                <Chip className={classes.chip} label="MaterialUi" />
                <Chip className={classes.chip} label="StockX API" />
                <Chip className={classes.chip} label="NEWS API" />
                <Chip className={classes.chip} label="JSX" />
              </div>
            </Paper>
          </Grid>
        </Grid>
