          ...
          <Grid container spacing={2} my={1}>
            ...
            <Grid item md={2} xs={4} height="70vh" >
              <div style={{display : "flex",flexDirection:"column",height :"70vh",justifyContent :"space-evenly" }}>
                <Image src="src/components/hero.png" syle = {{border : "1px solid black"}} height="10vh" fit="contain" />
                <Image src="src/components/hero.png" height="15vh" width = "20vh" fit="contain" />
