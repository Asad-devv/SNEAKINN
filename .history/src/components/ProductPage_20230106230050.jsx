...
const ProductPage = () => {
  ...
  const findPrize = (item)=>{
    const retailPrice = traits.find((trait) => trait.name === "retail-price");
  ...
  return (
    ...
    <Grid container height="100vh">
      ...
      >
        ...
        <Typography variant="subtitle1">{!isDemo?(product?.traits?.find((item)=>(item.price!==undefined ;
          console.log(item)) )?.value): (product?.price)}$</Typography>
        <Box display="flex" >
          <Box
            display="flex"
