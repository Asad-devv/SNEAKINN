...
//   };
  ...
  return (
    <>
      <div
        className={`relative bg-gradient-to-b ${color} from-red-500 to-rose-500 from-red-500 to-rose-500 ${shadow} grid items-center justify-items-center rounded-md py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105 my-3 mb-4`}
        style={{ height: "300px" }}
      >
        <div
