...
const images = [
  ...
  "https://static01.nyt.com/images/2020/10/29/fashion/26SNEAKERSPILL-wall/merlin_178616268_63bd34d3-8c9d-4d20-9ac2-0e16e20eadca-superJumbo.jpg?quality=75&auto=webp",
];
  ...
  return (
    <>
      <Carousel
        ...
        style={{ height: "80vh" ,backgroundColor:"grey"}}
        ...
        {images.map((image, i) => {
          return (
            <img
              src={image}
              alt="image"
              className="h-[90vh] w-full object-contain sm:object-fill  "
              key={i}
            />
          );
        })}
