...
const SearchBar = () => {
  ...
  return (
    <Box display="flex" flexDirection ="column">
      ...
      <Box display="flex" position="absolute" zIndex="10000" xs={{top:{md:"calc(60% + 10px)",xs:"20%",md:"4"},right:"20%"}} flexDirection = "column" >
        
        {filteredProducts.length>1 ? 
      filteredProducts?.map((val,i)=>{
        return(
            
                <Typography variant="subtitle" >{val.title}</Typography>
