      ...
      <ThemeProvider theme={styles}>
        <Box sx={{ height: "auto" }}>
          <Grid coverer spacing={2} my={1}>
            ...
            <Grid py={2} item md={4} xs={12} sm={12}>
              <div
              >
            ...
            <Grid item md={2} xs={4}>
              <div style={{display : "flex",flexDirection:"column"}}>
                <Image src="src/components/hero.png" height="10vh" fit="cover" />
                <Image src="src/components/hero.png" height="10vh" fit="cover" />
                <Image src="src/components/hero.png" height="10vh" fit="cover" />
          ...
          <img src="src/components/wave.png" fit="cover" />
        </Box>
      </ThemeProvider>
    </>
  );
