  ...
  return (
    <Grid container height = "100vh">
      ...
      <Grid height="80vh" sx={{  display: "flex", justifyContent:"center",alignItems:"a ",flexDirection: "column" }} item md={6} xs={12} sm={12}>
        ...
        <Typography py={3} width="40vh" variant="subtitle2">These low-profile sneakers are your perfect casual wear companion. Featuring a durable rubber outer sole, they’ll withstand everything the weather can offer</Typography>
      </Grid>
    </Grid>
  );
};
