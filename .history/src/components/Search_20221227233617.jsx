  ...
  return (
    <Box display="flex" flexDirection ="column">
      ...
      filteredProducts?.map((val,i)=>{
        return(
            (i<3) &&
           ( <div key={i} sx={{height:{md:"20px"},width:"10vh" ,backgroundColor:"white"}} >

                <Typography sx={{height:{md:"40px",xs:"20px",sm:"20px"},width:"10vh" ,backgroundColor:"white"}} variant="subtitle" >{val.title}</Typography>
                </div>)
        )
      }): (<></>)
      }
