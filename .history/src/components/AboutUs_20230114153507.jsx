      ...
      <Container maxWidth="md">
        <div className={classes.root}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={12} backgroundColor="blue" >
              <Paper className={classes.paper} backgroundColor= "blue" color="blue">
                <Typography variant="subtitle" backgroundColor= "blue"  className={classes.text}>
