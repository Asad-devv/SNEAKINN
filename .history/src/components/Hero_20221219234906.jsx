...
<ThemeProvider theme={styles}>
    <Box sx={{height:"auto",backgroundColor}}>
    <Grid container display="flex" spacing={2} my={2}>
        ...
        <Grid  py={2}  item md={6} xs={12} sm={12}>
          <div sx={{backgroundImage : "https://pngtree.com/freepng/red-lighting-circle-element_5995605.html"}} >
            <Image src="src/components/hero.png" shift="left" sx={{ filter: 'drop-shadow(10px 10px 30px black) invert(1%)',easing:"ease-in-out" }} height="70vh" fit="contain"  />
          </div>
        </Grid>
      </Grid>
      
      <Image src="src/components/wave.png" fit="contain"  />
