import { Box, Typography, Grid,Button, useTheme,use } from "@mui/material";
...
}) => 
{
  ...
  console.log(uTheme.breakpoints.down)
  return (
    <>
        ...
        <Box sx={{ height: "auto" }}>
          <Grid container spacing={2} my={1}>
            ...
            <Grid item md={2} xs={4} height="70vh">
              <div style={{display : "flex",flexDirection:`!${uTheme.breakpoints.down}? "row" :"column"`,height :"70vh"}}>
