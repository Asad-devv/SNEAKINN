...
const SearchBar = () => {
  ...
  return (
    <Box display="flex" flexDirection ="column" >
      ...
      <Box display="flex" position="absolute" boxShadow={2} zIndex="10000" sx={{top:"calc(60% + 10px)",width:{md:"30vh",xs:"25vh"},height:"25vh",borderRadius:"10px",right:{md:"30px"} ,textAlign:"center",backgroundColor:"white"}} py={3} px={1} gap={1} flexDirection = "column" >
