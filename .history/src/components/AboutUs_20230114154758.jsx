          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={12} pt={6}>
              <Paper className={classes.paper} pt={6} elevation={7} backgroundColor= "blue" rounded>
                ...
                Welcome to my sneaker website! I am Asad Ullah, a sneaker enthusiast who has created this website as a passion project. I understand the importance of having a place to buy sneakers, where you can find all the latest and greatest sneakers from top brands.
                </Typography>
                <div>
                <Typography variant="subtitle" className={classes.text}>
