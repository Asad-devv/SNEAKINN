        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          ...
          <div className="flex items-center">
            <img
              src="src/components/hero.png"
              alt="hero-img/img"
              className="w-[65vh] md:w-[24vh] h-[65vh] lg:h-[39vh] md:h-[26vh] sm:h-[21vh] xsm:h-[19vh] rotate-12 transitions-theme hover:rotate-0 cursor-pointer object-fill shadow pb-4"
            />
          </div>
        </div>
      </div>
