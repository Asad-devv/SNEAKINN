...
//   };
  ...
  return (
    <>
      <div
        className={`relative bg-gradient-to-b ${color} from-blue-600 to-blue-500  from-violet-500 to-indigo-500 shadow-lg shadow-violet-500 ${shadow} grid items-center justify-items-center rounded-md py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105 my-3 mb-4`}
        style={{ height: "300px" }}
      >
        <div
        ...
        >
          <LazyLoadImage
            ...
            placeholder={<img style={{objectFit :"contain"}} className={`transitions-theme h-36 w-64`} src={image} alt="image" />}
          />
        </div>
      </div>
    </>
