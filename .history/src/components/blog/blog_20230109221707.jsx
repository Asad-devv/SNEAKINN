...
const useStyles = makeStyles((theme) => ({
  ...
  hero: {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://sneakernews.com/wp-content/uploads/2022/12/UPCOMING-SNEAKER-RELEASES-2022-DEC-12-TO-18.jpg')`,
    height: "500px",
