          ...
          <Splide options={splideOptions}>
            {news.map((val, i) => (
              <SplideSlide key={i} className="mb-0.5">
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-900 hover:scale-105 transition-all duration-700 ease-in-out ring-1 my-3 ring-slate-200">
                {/* href={val.url} */}
                <a href={val.url} target="_blank">
                  ...
                  <div className="grid items-center justify-items-start px-4">
                    <h1 style={{fontFamily:"Unbounded"}} className="text-base font-semibold lg:text-sm">{val.title}</h1>
