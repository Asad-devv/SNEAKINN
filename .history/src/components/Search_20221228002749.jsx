...
const SearchBar = () => {
  ...
  return (
    <Box display="flex" flexDirection ="column">
      ...
      <Box display="flex" position="absolute" zIndex="10000" sx={{top:"calc(60% + 10px)",width:"30vh",height:"30vh",right:"30px" ,backgroundColor:"white"}} py={} gap={1} flexDirection = "column" >
