...
<ThemeProvider theme={styles}>
    ...
    <Grid container display="flex" spacing={2} my={1}>
        <Grid  sx={{padding : "100px",backgroundColor:"pink"}}display = "flex" flexDirection = "column"  justifyContent="center" height="80vh" item md={6} xs={12} sm={12}>
          
        <Typography fontWeight="900" variant="h1">BEST SNEAKERS </Typography>
        <Typography fontWeight="900" variant="h3">IN TOWN</Typography>
        <Typography overflow="hidden" py={2} width="50vh" fontSize="12px" variant="h6" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Et distinctio suscipit numquam quas possimus magni explicabo?</Typography>  
        </Grid>
