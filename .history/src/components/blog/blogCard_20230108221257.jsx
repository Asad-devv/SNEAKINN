...
const BlogCard = ({ title, text,url, publishedAt,urlToImage, author, date, onClick }) => {
  const classes = useStyles();
  // console.log(title, text, imageUrl, author, date, onClick)
  return (
    <Card className={classes.card}>
      <CardActionArea href={url} targert="_blacmk" onClick={onClick}>
...
const Asad = ({ title, text, imageUrl, author, date, onClick }) => (
  <Card>
