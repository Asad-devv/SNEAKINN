      ...
      >
        ...
        >
          ...
          <div className="flex items-center pb-3 gap-3">
            <button
              type="button"
              className="bg-white/90 blur-effect-theme hover:scale-110  h-auto button-theme p-0.5 drop-shadow"
              onClick={() => onAddToCart()}
            >
            ...
            <button
              type="button"
              className="bg-white/90 h-auto w-auto blur-effect-theme button-theme px-2  shadow  text-sm text-black hover:scale-110"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
            ...
            <button  type="button"
              className="bg-white/90 blur-effect-theme h-auto w-auto  button-theme p-0.5 hover:scale-110 shadow" ><Link to={`/Products/${id}`} style={{fontFamily:"Trade Gothic LT Std"}} >See More</Link></button>
