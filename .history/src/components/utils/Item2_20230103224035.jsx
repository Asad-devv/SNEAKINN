...
//   };
  ...
  return (
    <>
      <div
        className={`relative bg-gradient-to-b ${color} from-blue-600 to-blue-500  shadow-lg shadow-violet-500 ${shadow} grid items-center justify-items-center rounded-md py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105 my-3 mb-4`}
        style={{ height: "300px" }}
      >
        <div
        ...
        >
          <h1 className="text-slate-900 text-xl lg:text-lg md:text-base font-medium filter drop-shadow">
            {name.substring(0,20)} {name.length>1 && <div>...</div>}
          </h1>
        ...
        >
          ...
          >
        <img  className={`transitions-theme h-36 w-64`} src={image} alt="image" />  
