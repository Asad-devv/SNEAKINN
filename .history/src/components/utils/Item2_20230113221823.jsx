  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex items-center sm:w-[10rem] mb-2 justify-center p-0.5 rounded-lg`}
        ...
        >
          <LazyLoad 
            ...
            // alt={`img/item-img/${id}`}
            className={`transitions-theme mb-2 sm:w-[8rem] sm:h-[auto] h-37 w-64`}
            // placeholder={<img  className={`transitions-theme h-36 w-64`} src={image} alt="image" />}
          >
        <img loading="lazy" className={`transitions-theme  sm:w-[9rem] mb-2 h-37 w-64`} src={image} alt="image" />  
