  ...
  return (
    <>
      <ThemeProvider theme={styles}>
        <Box sx={{ height: "100vh" ,backgroundImage : "url('src/acomponents/wave.png')"}}>
          <Grid container sx={{ backgroundImage : "url('src/components/wave.png')"}} spacing={2} my={1}>
            <Grid
            ...
            <Grid item md={2} xs={4} height="70vh">
              <div style={{display : "flex",flexDirection:"column",height :"70vh",justifyContent :"space-"}}>
