          ...
          <Grid container spacing={2} my={1}>
            ...
            <Grid item md={2} xs={4} height="70vh" >
              <div style={{display : "flex",flexDirection:"column",height :"70vh",justifyContent :"space-evenly" }}>
                <Image src="https://icon2.cleanpng.com/20180913/ohx/kisspng-air-jordan-1-mid-men-s-shoe-mens-air-jordan-1-retr-5b9abad05aca63.9420216815368670243719.jpg" width = "20vh" p={1} style = {{border : "1px solid" ,borderRadius:"5px"}} fit="contain" />
                <Image  src=" https://www.pngarts.com/files/8/Air-Force-One-White-Nike-Shoes-Transparent-Background-PNG.png" height="19vh" width = "20vh" p={1} style = {{border : "1px solid" ,borderRadius:"5px"}} fit="contain" />
